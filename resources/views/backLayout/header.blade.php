  ...
  <link rel="stylesheet" href="{{ URL::asset('/backend/vendors/iCheck/skins/flat/green.css') }}">
  <!-- Datatables -->
  ...
  <link rel="stylesheet" href="{{ URL::asset('/backend/vendors/datatables.net-responsive-bs/css/responsive.bootstrap.min.css') }}">
    ...
    <link href="{{ URL::asset('/backend/build/css/mystyle.css') }}" rel="stylesheet">
<!--  <script src="//{{ Request::getHost() }}/backend/vendors/socket/socket.io.js"></script> -->
