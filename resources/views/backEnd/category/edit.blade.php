...
@section('title')
{{ __('bck_category.Edit_Category') }}
@stop

@section('content')

    <h1>{{ __('bck_category.Edit_Category') }}</h1>
    <hr/>
    ...
    {!! Form::model($category, [
        ...
        'class' => 'form-horizontal'
            ...
            <div class="form-group {{ $errors->has('is_parent') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                                <div class="checkbox">
                <label>{!! Form::radio('is_parent', '1') !!}  {{ __('bck_category.Yes') }} </label>
            </div>
            <div class="checkbox">
                <label>{!! Form::radio('is_parent', '0', true) !!}  {{ __('bck_category.No') }} </label>
            </div>
