...
@section('title')
{{ __('bck_users.User_details') }}
@stop

@section('content')
<div class="panel panel-default">
        <div class="panel-heading">{{ __('bck_users.User') }}  {{$user->name}} {{ __('bck_users.Permissions') }}</div>
...
<script type="text/javascript">
    $('.select').SumoSelect({ selectAll: true, placeholder: '{{ __('bck_users.Nothing_selected') }}' });
</script>
@endsection
