...
@section('title')
{{ __('bck_users.Create_new_Zipcode') }}
@stop

@section('content')

    <h1>{{ __('bck_users.Create_new_Zipcode') }}</h1>
    <hr/>

    {!! Form::open(['url' => 'zipcode', 'class' => 'form-horizontal']) !!}
    ...
    <div class="form-group">
        <div class="col-sm-offset-3 col-sm-3">
            {!! Form::submit( __('bck_users.Create'), ['class' => 'btn btn-primary form-control']) !!}
        </div>
    </div>
    {!! Form::close() !!}
