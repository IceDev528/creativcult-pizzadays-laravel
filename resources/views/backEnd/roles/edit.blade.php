...
@section('title')
{{ __('bck_roles.Edit_role') }} : {{$role->name}}
@stop

@section('content')
<div class="panel panel-default">
        <div class="panel-heading">{{ __('bck_roles.Edit_role') }} :{{$role->name}} </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-3 col-sm-3">
            {!! Form::submit( __('bck_roles.Update'), ['class' => 'btn btn-success form-control']) !!}
        </div>
